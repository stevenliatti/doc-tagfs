...
% TODO: schéma global des deux programmes avec interactions
...
dans le répertoire \mintinline{text}{/home/stevenliatti}. Tout d'abord, Tag Manager est utilisé pour 
...
\begin{code}
    \inputminted[bgcolor=mygray,breaklines,breaksymbol=,linenos,frame=single,stepnumber=1,
        tabsize=2,firstline=85,lastline=110]{rust}{../tag_engine/src/graph.rs}
...
\begin{code}
    \inputminted[bgcolor=mygray,breaklines,breaksymbol=,linenos,frame=single,stepnumber=1,
        tabsize=2,firstline=220,lastline=232]{rust}{../tag_engine/src/graph.rs}
...
brutes, dont \mintinline{bash}{dot} utilisé ici. À partir du fichier graph.dot, disponible au 
