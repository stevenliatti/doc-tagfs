...
Mes remerciements vont en premier lieu à ma compagne, pour son infinie patience et ses encouragements.
...
de sur le \acrshort{fs} de la machine et les sockets IP (type \mintinline{c}{AF_INET} ou 
